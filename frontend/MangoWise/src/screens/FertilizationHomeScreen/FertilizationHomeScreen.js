...
export default function FertilizationHomeScreen() {
  ...
  return (
    <View style={{ backgroundColor: '#fdfafa', height: '100%' }}>
      ...
      <Text style={{ fontSize: 20, fontFamily: 'Roboto', paddingTop: 2, textAlign: 'left', paddingRight: 13, marginLeft: 20, fontStyle: 'italic' }}>Empower your plants with</Text>
      <Text style={{ fontSize: 20, fontFamily: 'Roboto', paddingTop: 2, textAlign: 'left', paddingRight: 13, marginLeft: 20, fontStyle: 'italic' }}>essential nutrients</Text>
      <View style={styles.imageContainer}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 0 }}>
          <View style={{ flexDirection: 'column', marginTop: 5 }}>
            <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 10, marginTop: -20 }}>Test soil </Text>
            <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 10, marginTop: 0 }}>nutrients</Text>
          </View>
          <Image
            source={vector}
          ...
          />
          <View style={{ flexDirection: 'column', marginTop: 5 }}>
            <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 5, marginTop: -20 }}>Get fertilizer </Text>
            <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 5, marginTop: 0 }}>suggestions</Text>
          </View>
          <Image
            source={vector}
            style={styles.vectorimage}
          ...
          />
          <View style={{ flexDirection: 'column', marginTop: 5 }}>
            <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 5, marginTop: -20 }}>Monitor </Text>
            <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 5, marginTop: 0 }}>nutrients level</Text>
          </View>
        </View>
      ...
      <View style={{ marginTop: 10 }}>
        ...
        <Text style={{ fontSize: 12, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 15, marginTop: 0, fontStyle: 'italic', color: 'red' }}>Please note:</Text>
        <Text style={{ fontSize: 10, textAlign: 'left', paddingRight: 13, marginLeft: 15, marginTop: 3, fontStyle: 'italic' }}>You need to connect your mobile phone with the sensor using Bluetooth connection.</Text>
      </View>
      ...
      <TouchableOpacity onPress={() => setModalVisible(true)}>
        <View style={{ flexDirection: 'row' }}>
          <AntDesign name="infocirlceo" size={24} color="black" style={{ marginTop: 20, marginLeft: 20 }} />
          <Text style={{ fontSize: 14, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 10, marginTop: 10, textDecorationLine: 'underline', fontStyle: 'italic' }}>Get step by step guidance to </Text>
        </View>
        <Text style={{ fontSize: 14, fontFamily: 'Roboto', textAlign: 'left', paddingRight: 13, marginLeft: 50, marginTop: -5, textDecorationLine: 'underline', fontStyle: 'italic' }}>setup the sensor</Text>
      </TouchableOpacity>
    </View>
  )
}
