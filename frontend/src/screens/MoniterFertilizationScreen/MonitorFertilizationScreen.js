    ...
    <View style={{ backgroundColor: "#fdfafa", height: "101%" }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
            ...
            {newquantity > 50 ? (
              <View>
                <Entypo
                  ...
                  size={60}
                  color="#118424"
                  style={{ marginTop: 5, marginLeft: 110 }}
                />
                <Text
                  style={{ fontSize: 16, marginTop: 40, fontWeight: "bold" }}
                >
                  {" "}
                  Please add {newfertilizer} {newquantity}g{" "}
                </Text>
                <Text
                  style={{
                    fontSize: 16,
        ...
        <View style={{ flexDirection: "row" }}>
          <Text style={{ fontSize: 14, marginLeft: 20, marginTop: 20 }}>
            {" "}
            Phosporus (P) :{" "}
          </Text>
